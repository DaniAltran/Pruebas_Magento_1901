...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2014 a las 17:48:24
...
(1, 'Daniel', 'Herrera', 'daniel.herreracubells@altran.com', 'magento', 'e2729c445bf56c418a6cd3e409a52999:NqjIlPzL7ZRnOqYw7jExG33bDhThFLB3', '2014-11-17 12:03:57', '2014-11-17 12:03:57', '2014-11-24 11:38:20', 13, 0, 1, 'a:1:{s:11:"configState";a:7:{s:12:"dev_restrict";s:1:"0";s:9:"dev_debug";s:1:"1";s:12:"dev_template";s:1:"0";s:20:"dev_translate_inline";s:1:"0";s:7:"dev_log";s:1:"0";s:6:"dev_js";s:1:"0";s:7:"dev_css";s:1:"0";}}', NULL, NULL);
...
(1, 1, 1, '0.0000', '0.0000', 1, 0, 0, 1, '1.0000', 1, '0.0000', 1, 0, '2014-11-20 13:56:18', NULL, 1, 0, 1, 1, 1, '0.0000', 1, 0, 0),
(2, 2, 1, '0.0000', '0.0000', 1, 0, 0, 1, '1.0000', 1, '0.0000', 1, 0, '2014-11-24 10:32:45', NULL, 1, 0, 1, 1, 1, '0.0000', 1, 0, 0);
...
(1, 3, 0, 0, '2014-11-17 12:01:01', '2014-11-17 12:01:02', '1', 0, 0, 1),
(2, 3, 3, 1, '2014-11-17 12:01:03', '2014-11-17 12:01:03', '1/2', 1, 1, 0);
...
(1, 4, 4, 'simple', 'N-5', 0, 0, '2014-11-20 13:56:16', '2014-11-20 13:56:16'),
(2, 4, 4, 'simple', 'DANI-PROD', 0, 0, '2014-11-24 10:30:30', '2014-11-24 10:32:44');
...
`value_id` int(11) NOT NULL COMMENT 'Value ID',
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  `value` decimal(12,4) DEFAULT NULL COMMENT 'Value'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Decimal Attribute Backend Table' AUTO_INCREMENT=9 ;
...
`value_id` int(11) NOT NULL COMMENT 'Value ID',
  ...
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table' AUTO_INCREMENT=43 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Url Rewrites' AUTO_INCREMENT=3 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Index Event' AUTO_INCREMENT=10 ;
...
(1, 'catalog_product_attribute', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time'),
(2, 'catalog_product_price', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:46', 'real_time'),
(3, 'catalog_url', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time'),
(4, 'catalog_product_flat', 'require_reindex', NULL, NULL, 'real_time'),
(5, 'catalog_category_flat', 'require_reindex', NULL, NULL, 'real_time'),
(6, 'catalog_category_product', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time'),
(7, 'catalogsearch_fulltext', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time'),
(8, 'cataloginventory_stock', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time'),
(9, 'tag_summary', 'require_reindex', '2014-11-24 10:32:45', '2014-11-24 10:32:45', 'real_time');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log URL Info Table' AUTO_INCREMENT=53 ;
...
`visitor_id` bigint(20) unsigned NOT NULL COMMENT 'Visitor ID',
  ...
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log Visitors Table' AUTO_INCREMENT=19 ;
...
--
ALTER TABLE `adminnotification_inbox`
MODIFY `notification_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Notification id',AUTO_INCREMENT=103;
--
...
--
ALTER TABLE `core_url_rewrite`
MODIFY `url_rewrite_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rewrite Id',AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `index_event`
MODIFY `event_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Event Id',AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `log_url_info`
MODIFY `url_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'URL ID',AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT de la tabla `log_visitor`
--
ALTER TABLE `log_visitor`
MODIFY `visitor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Visitor ID',AUTO_INCREMENT=19;
--
